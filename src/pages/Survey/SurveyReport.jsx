...
import Table from '@mui/joy/Table';
  ...
  const row2=[
    ...
    createData('Excessive use of allopathiy medicine (એલોપથી દવાઓના અતિશય ઉપયોગ થી)', '3%','1%','2%'),
  ...
  const row4=[
    ...
    createData('Did you observe that you have regained your body weight? શું તમારુ ઘટેલું વજન ફરીથી વધ્યું છે?','15','6%','8%'),
            ...
            <div className="bg-[#FEFAF6]">
                ...
                <div className="grid grid-cols-2 bg-[#F6F5F2]">       
                    <div className="flex flex-col p-10 items-center border-1 ">
                        <label className="font-semibold  text-[#1F2937] text-lg">Obesity based on BMI</label>
                    ...
                    <div className="flex flex-col p-10 items-center border-1 ">
                        <label className="font-semibold text-[#1F2937] text-lg">The key reason for the weight gain is base on participants opinion</label>
                        <Table aria-label="striped table" >
                            <thead>
                            <tr>
                                <th  style={styles.reason} >Reason</th>
                    ...
                    <div className="flex flex-col  p-10 items-center border-1 ">
                        <label className="font-semibold text-[#1F2937] text-lg">As per our scientific study the following key possibility for weight gain</label>
                        <Table aria-label="striped table" >
                            <thead>
                            <tr>
                                <th  style={styles.reason} >Reason</th>
                    ...
                    <div className="flex flex-col p-10 items-center border-1 ">
                        <label className="font-semibold text-[#1F2937] text-lg">Participants of the survey are suffering the following disease, due to overweight</label>
                        <Table aria-label="striped table" >
                            <thead>
                            <tr>
                                <th  style={styles.reason}>Reason</th>
                ...
                <div className="grid grid-cols-2 bg-[#F6F5F2]">
                    <div className="flex flex-col p-20 items-center border-1" style={tableContainerStyle}>
                            <label className="font-semibold  text-[#1F2937] text-lg">Gender</label>
                            <Table aria-label="striped table" >
                                <tbody>
                                {gender.map((row) => (
                                    <tr >
                    ...
                    <div className="flex flex-col p-10 items-center border-1 " style={tableContainerStyle}>
                            <label className="font-semibold  text-[#1F2937] text-lg">Age</label>
                            <Table aria-label="striped table" >
                                <thead>
                                <tr>
                ...
                <div className="bg-[#F6F5F2]">
                    <div className="flex flex-col  p-10 items-center border-1 " style={tableContainerStyle}>
                            <label className="font-semibold text-[#1F2937] text-lg">Summary of Fat Deposition Area</label>
                            <Table aria-label="striped table" >
                                <thead>
                                <tr>
                                    <th  style={styles.reason} >Reason</th>
                            ...
                            <h2 className="font-semibold text-[#1F2937] text-lg">Note:The overall report may vary by 1%</h2>
                    </div>
                </div>
            </div>
        </main>
