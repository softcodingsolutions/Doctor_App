      ...
      <div className="flex p-4 h-full flex-col space-y-4">
        ...
        <div className="w-full flex justify-center p-4 shadow-gray-400 shadow-inner border rounded-md border-gray-100 animate-once animate-ease-out overflow-auto h-[93%]">
          <form
            ...
            method="post"
          >
           <div>Enter all your meal details from Breakfast to Dinner <br/>સવારથી સાંજની બધી ખાવા-પીવાની આદત ભરો</div> 
           <div className='flex flex-col gap-10 justify-between w-full'>
            ...
            <div className="flex w-full justify-center gap-3">
              <button type='submit' name='Back' className='w-[20rem] p-1 text-white bg-black rounded-md border border-gray-500 font-medium text-lg hover:scale-105' onClick={handleBack}>Back</button>
