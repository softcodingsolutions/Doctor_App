      ...
      <div className="flex-grow overflow-x-hidden overflow-y-auto flex flex-col">
        {sidebarItems.map((i) => (
          <Link
            ...
            key={i.id}
            className={clsx(
              "w-full mt-6 flex items-center text-base px-3 py-1.5 sm:px-0 xl:px-3 justify-start sm:justify-center xl:justify-start sm:mt-6 xl:mt-3 cursor-pointer",
        ...
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 sidebar-separator-bottom">
          ...
          >
            <div className="text-lg font-semibold">
              {franchise?.first_name?.toUpperCase()[0]}
              {franchise?.last_name?.toUpperCase()[0]}
            </div>
          </div>
