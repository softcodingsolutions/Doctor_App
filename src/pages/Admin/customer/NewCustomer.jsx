  ...
  return (
    <div className="flex w-full">
      ...
      <Stepper sx={{ width: '100%', height:"7%"}}>
        ...
        {currentStep === 0 && <CustomerGeneralDetails onNext={handleNextStep} />}
        {currentStep === 1 && <QueCurrentDiet onNext={handleNextStep} onBack={handleBackStep} />}
        {currentStep === 2 && <QueFamilyHistory onNext={handleNextStep} onBack={handleBackStep} />}
        {currentStep === 3 && <QueComplains onNext={handleNextStep} onBack={handleBackStep} />}
        {currentStep === 4 && <CustomerQuestionsPart1 onNext={handleNextStep} onBack={handleBackStep} />}
        {currentStep === 5 && <CustomerQuestionsPart2 onNext={handleNextStep} onBack={handleBackStep} />}
