    ...
    <div className="w-full p-2">
      <div className="rounded-lg bg-card h-[82vh] bg-white">
        <div className="flex p-5 h-full flex-col items-center">
          <div className="flex w-2/3 justify-between text-lg font-semibold mt-1">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex justify-between w-full">
                <div className="w-1/2 text-right break-words">Gender:</div>
                <div className="w-1/2 pl-3">
              ...
              <div className="flex justify-between w-full">
                <div className="w-1/2 text-right break-words">Age:</div>
                <div className="w-1/2 pl-3">
              ...
              <div className="flex justify-between w-full">
                <div className="w-1/2 text-right break-words">Package:</div>
                <div className="w-1/2 pl-3">
