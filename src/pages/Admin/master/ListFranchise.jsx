        ...
        <div className="w-full p-2">
          <div className="rounded-lg bg-card h-[91vh] bg-white">
            <div className="flex px-4 py-3 h-full flex-col space-y-4">
              ...
              <div className="animate-fade-left animate-delay-75 shadow-gray-400 shadow-inner border rounded-md border-gray-100 animate-once animate-ease-out overflow-auto h-[70%]">
