...
function Section2({ scrollYProgress }) {
  ...
  return (
    ...
    >
      ...
      <div className="font-teachers text-balance tracking-wider text-lg space text-center mt-20 text-gray-700 w-2/3">
        <span className="text-green-600 font-medium">Slim and Smile</span> Ayu
      ...
      <button className="border border-gray-300 p-4 tracking-wide rounded-full text-xl font-teachers font-semibold bg-green-400 text-white hover:bg-white hover:text-green-500 transition-colors mt-20 mb-8">
