...
function UserQuestionsPart2({
  ...
  return (
    <div className="w-full m-5 gap-2 overflow-auto flex rounded-lg bg-card h-[82vh] bg-white flex-wrap content-start p-2 px-4">
...
export default UserQuestionsPart2;
