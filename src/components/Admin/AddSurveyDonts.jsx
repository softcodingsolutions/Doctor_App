...
const AddSurveyDonts = forwardRef((props) => {
  ...
  const submittedData = (d) => {
    ...
    formdata.append("survey_dont[in_english]", text.english);
    formdata.append("survey_dont[in_gujarati]", text.gujarati);

    axios.post(`/api/v2/survey_donts`, formdata)
      .then((res) => {
        console.log(res);
        props.refresh();
      })
